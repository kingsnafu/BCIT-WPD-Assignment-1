...
class BCIT_WPD_Restrict_Purchse_Meta{
	...
	/**
	* Remove purchase button if product is restricted
	*
	* @since 1.0
	* @author Rose Cass
	*/
	...
	/**
	* Add our metaboxes to start our metaboxes
	*
	* @since 1.0
	* @author Rose Cass
	*/
	...
	/**
	* Add the metabox with add_meta_box
	*
	* @since 1.0
	* @author Rose Cass
	*
	* @uses add_meta_box()		Add the metabox to our site with the args
	*
	*/
	...
	public function save_post_meta( $post_id, $post ){
		...
		if ( empty( $_POST['bcit-wpd-restrict-content-message'] ) ){
			...
			update_post_meta( absint( $post_id ), '_bcit_wpd_restrict_content_message', esc_attr( $value ) );
		}
...
}// BCIT_WPD_Restrict_Purchse_Meta

new BCIT_WPD_Restrict_Purchse_Meta();